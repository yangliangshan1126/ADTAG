...
function initFullpage() {
	...
	var s = "fullpage-wrapper",
		...
		it = {
			...
			fadeScrollbars: !1,
			disableMouse: !0, //禁用鼠标
			interactiveScrollbars: !0 //交互式滚动条
		};
...
"undefined" != typeof NotifyMe && (NotifyMe.myAlert = function(e) {
	...
	*/
	e.preventDefault(), doReg(23786)
});
var touchclick = "touchstart" in document ? "touchstart" : "click";
$(window).on("resize orientationchange", adjustSize);
adjustSize(), /iPhone|iPad|iPod|Android/i.test(navigator.userAgent) ? (ismobile = !0, $("body").addClass("mobile"), $(".loadingwrapper").hide(), setTimeout(function() {
	$(".loadingwrapper").show()
}, 1e3), document.title = "UP2017腾讯互娱年度发布会") : "";
$("#fullpage .dot").prepend("<b></b>"), $("#pop .pop-close").on("click", function() {
	...
	$("body").on("resloaded", function() {
		...
		var interva = new Date - jsBeginTime,
			t = interva > 4500 ? 0 : 4500 - interva;
...
})), supportWebGL ? ($.getScript("js/pkg/webgl.js", function() {}), $("body").addClass("webglyes")) : (tryPgvSendClick(ismobile ? {
	hottag: "a20170301pre.support.mobilewebglno"
} : {
	hottag: "a20170301pre.support.pcwebglno"
}), toggleParticle = function() {}, $("body").addClass("webglno"), $("body").addClass("introed"), $("body").addClass("resloaded"), $("body").addClass("hideloading"), $(".chromeframe").addClass("show"), initFullpage(), 
	introed = !0), $(".skipintro").one(touchclick, function() {
